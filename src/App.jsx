      ...
      <div className='Sobre-container'>
        ...
        <div className='Sobre-body-container'>
          ...
          <div>
            ...
            <p className='Sobre-text'>Além dos projetos corporativos, também desenvolvo projetos pessoais, incluindo aplicativos publicados na Google Play, onde exploro novas tecnologias e fortaleço minha experiência em desenvolvimento Mobile.</p>
          </div>         
        </div>
